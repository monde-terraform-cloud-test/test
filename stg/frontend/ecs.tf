  ...
  container_definitions = jsonencode([
    {
      ...
      "environmentFiles" : [
        {
          "value" : "arn:aws:s3:::edion-ecsite-stg-config/frontend/develop.env",
          "type" : "s3"
        }
      ],
      "portMappings" : [
    ...
    },
    {
      ...
      "secrets" = [
        {
          "name" : "DD_API_KEY",
          "valueFrom" : "arn:aws:secretsmanager:ap-northeast-1:681446296757:secret:DdApiKeySecret-HIeDWgeq81yF-zk7IyF"
        },
      ]
      "logConfiguration" : {
        "logDriver" : "awslogs",
