locals {
  iam_user = { # NEW_EC_INFRA-1
    "operator-user-01"     = aws_iam_group.operator.name
    "operator-user-02"     = aws_iam_group.operator.name
    "operator-user-03"     = aws_iam_group.operator.name
    "operator-user-04"     = aws_iam_group.operator.name
    "operator-user-05"     = aws_iam_group.operator.name
    "operator-user-06"     = aws_iam_group.operator.name
    "operator-user-07"     = aws_iam_group.operator.name
    "operator-user-08"     = aws_iam_group.operator.name
    "operator-user-09"     = aws_iam_group.operator.name
    "operator-user-10"     = aws_iam_group.operator.name
    "operator-user-11"     = aws_iam_group.operator.name
    "operator-user-12"     = aws_iam_group.operator.name
    "operator-user-test01" = aws_iam_group.operator.name
    "readonly-user-test01" = aws_iam_group.readonly.name
    # "readonly-user-01"       = aws_iam_group.readonly.name
    # "readonly-user-02"       = aws_iam_group.readonly.name
    # "readonly-user-03"       = aws_iam_group.readonly.name
    # "readonly-user-04"       = aws_iam_group.readonly.name
    # "readonly-user-05"       = aws_iam_group.readonly.name
    "edion-ota"            = aws_iam_group.edion.name # NEW_EC_INFRA-86
  }
...
data "aws_iam_policy_document" "operator_switch_policy" {
  statement {
    ...
    resources = [
      "arn:aws:iam::681446296757:role/edion-ecsite-dev-operator-switch-role",
...
data "aws_iam_policy_document" "s3_access_policy" {
  statement {
    ...
    resources = [
      data.aws_s3_bucket.common["user_upload_image"].arn,
    ]
  }
  statement {
